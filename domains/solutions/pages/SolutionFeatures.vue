<template>
  <div class="solution-features">
    ...
    <div class="alert alert-info d-flex align-items-center mb-5">
      ...
      <div>
        <h4 class="alert-heading mb-1">Manage Features</h4>
        <p class="mb-0">Add and manage features for this solution. Features highlight the key capabilities and functionalities.</p>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title">
          <h3 class="fw-bold m-0">
            Features List
            <span class="badge badge-light-primary ms-2" v-if="currentSolution">
              {{ currentSolution.features?.length || 0 }}
            </span>
          </h3>
        </div>
      ...
      <div class="card-body">
        <!-- Features List -->
        <div v-if="currentSolution?.features && currentSolution.features.length > 0">
          <div
          ...
          >
            <div class="d-flex align-items-center flex-grow-1">
              <div class="symbol symbol-50px me-4" v-if="feature.icon">
              ...
              <div class="flex-grow-1">
                ...
                <div class="text-gray-600 fs-6" v-if="feature.description">
                  {{ feature.description }}
                </div>
        ...
        <div v-else class="text-center py-10">
          <i class="ki-duotone ki-abstract-26 fs-5x text-muted mb-5">
            <span class="path1"></span>
            <span class="path2"></span>
          </i>
