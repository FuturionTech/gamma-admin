<template>
  <div class="industry-form-settings">
    <!-- Category -->
    <div class="mb-7">
    ...
    <div class="mb-7">
      ...
      <InputText
        :modelValue="modelValue.icon_color || ''"
        @update:modelValue="updateField('icon_color', $event)"
        placeholder="e.g. #8b5cf6 or text-primary"
        :error="errors.icon_color"
      />
      <div class="form-text" v-if="!errors.icon_color">
        Color for the industry icon (hex code or CSS class)
      </div>
    </div>
    ...
    <div class="mb-7">
      ...
      <div class="form-text mt-2">
        Enable or disable this industry on the website
      </div>
    </div>
  </div>
</template>
